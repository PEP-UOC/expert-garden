							...
							<Layout style={{ ...gloStyles.layout }}>
								...
								<View style={{ ...gloStyles.view }}>
									...
									<View style={{ ...gloStyles.section.fullStart }}>
										...
										<ModalOptions mainText={'Guardado!'} show={saved} setShow={setSaved} option1text={'Añadir otro detalle al servicio'} option1onPress={() => console.log('Ver')} option2text={'Ver resumen del servicio'} option2onPress={() => console.log('Ver')} />
